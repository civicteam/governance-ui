    ...
    ;(async () => {
      ...
      if (client && client.predecessorClient) {
        ...
        if (voteWeightRecordPK) {
          ...
          console.log('useRecords: predecessor voter weight record not found')
          setPredecessorVoteWeightRecord({
            publicKey: null,
            accountExists: false,
            accountRequired: true,
        ...
        console.log('useRecords: predecessor voter weight record not needed')
        setPredecessorVoteWeightRecord({
          publicKey: null,
          accountExists: false,
