...
export const IDL: Quadratic = {
  ...
  errors: [
    ...
    },
    {
      ...
      name: 'InvalidPredecessorTokenOwnerRecord',
      msg:
        'Invalid TokenOwnerRecord as input voter weight (expecting TokenOwnerRecord V1 or V2)',
    },
    {
      code: 6003,
      name: 'InvalidPredecessorVoterWeightRecord',
      msg:
        'Invalid VoterWeightRecord as input voter weight (expecting VoterWeightRecord)',
    },
    {
      code: 6004,
      name: 'InvalidPredecessorVoterWeightRecordRealm',
    ...
    },
    {
      ...
      name: 'InvalidPredecessorVoterWeightRecordGovTokenMint',
      msg:
        'Invalid VoterWeightRecord governance token mint for input voter weight',
    },
    {
      code: 6006,
      name: 'InvalidPredecessorVoterWeightRecordGovTokenOwner',
      msg:
        'Invalid VoterWeightRecord governance token owner for input voter weight',
    },
    {
      code: 6007,
      name: 'InvalidVoterWeightRecordRealm',
